...
Revision ID: 1fe1f23e7dbd
Revises: 
Create Date: 2019-06-20 15:19:59.147401
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['fkey_tour_address_id'], ['addresses.id'], ),
    sa.ForeignKeyConstraint(['fkey_tour_user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
