...
Revision ID: 8de8434aa8c8
Revises: 
Create Date: 2019-06-22 08:15:18.852391
...
def upgrade():
    ...
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=True),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=True),
    sa.Column('fkey_user_address_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['fkey_user_address_id'], ['addresses.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['fkey_order_address_id'], ['addresses.id'], ),
