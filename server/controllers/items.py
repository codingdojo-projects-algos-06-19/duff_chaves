...
def admin_add_items():
    ...
    logged_in_user = User.query.get(session['user_id'])
    if logged_in_user.approval_id == 9:
        return render_template('admin_add_items.html', logged_in_user=logged_in_user)
    else:
...
def admin_item_edit(id):
    ...
    if logged_in_user.approval_id == 9:
        ...
        return render_template('admin_item_edit.html', logged_in_user=logged_in_user, item=item)
    else:
        return render_template('page_not_found.html', logged_in_user=logged_in_user)
